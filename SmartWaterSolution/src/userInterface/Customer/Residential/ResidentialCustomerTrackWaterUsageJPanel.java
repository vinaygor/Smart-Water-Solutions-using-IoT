 ...
 * @author vinay
 */
public class ResidentialCustomerTrackWaterUsageJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ResidentialCustomerTrackWaterUsageJPanel
     */
    ...
    public ResidentialCustomerTrackWaterUsageJPanel(JPanel userProcessContainer, Enterprise enterprise, UserAccount account) {
       initComponents();
    ...
    private void initComponents() {
        ...
        storageTankCapacityTxtField = new javax.swing.JTextField();
        ...
        jLabel3.setText("My Water Usage");
        ...
        storageTankCapacityTxtField.setEditable(false);
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(storageTankCapacityTxtField))))
                                .addGap(70, 70, 70)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(14, 14, 14)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(storageTankCapacityTxtField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void startBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBtnActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if((account.getCustomer().getConsumer().getStorageTank().getCapacity()<account.getCustomer().getConsumer().getStorageTank().getLevelSensor())&&(account.getCustomer().getRainWaterTank().getCapacity()<account.getCustomer().getRainWaterTank().getLevelSensor()))
            {
                flag = true;
    ...
    private void refillStorageTankActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refillStorageTankActionPerformed
        ...
        account.getCustomer().getConsumer().getStorageTank().setCapacity((account.getCustomer().getConsumer().getStorageTank().getTotalCapacity()));
        storageTankCapacity = Math.round(account.getCustomer().getConsumer().getStorageTank().getCapacity()*100);
       storageTankCapacityTxtField.setText(String.valueOf((storageTankCapacity/100.0)));
       emptyTank=true;
    ...
    private void refillRainwaterTankActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refillRainwaterTankActionPerformed
        ...
        else if(Double.parseDouble(rainfallLevelTxtField.getText())>=account.getCustomer().getRainWaterTank().getLevelSensor())
        {
            ...
            account.getCustomer().getRainWaterTank().setCapacity(account.getCustomer().getConsumer().getStorageTank().getTotalCapacity());
            double rainWaterStorage=Math.round((account.getCustomer().getRainWaterTank().getCapacity()*100.0));
           rainWaterTankCapacityTxtField.setText(String.valueOf(rainWaterStorage/100.0));        
       ...
       if(tempFlag){
        ...
        else
        {
            //System.out.println("Inside else");
                    ...
                    if(account.getCustomer().getConsumer().getStorageTank().getCapacity()>account.getCustomer().getConsumer().getStorageTank().getLevelSensor())
                                {
                                    account.getCustomer().getConsumer().getStorageTank().setCapacity(((account.getCustomer().getConsumer().getStorageTank().getCapacity()-sensor.getFlowRateSample(rnd))));   
                                    account.getCustomer().getConsumer().addIntoTrackWaterUsageMap(waterOutlet.getWaterOutletName(), sensor.getFlowRateSample(rnd));
...
//       if(thread.getName().equals(waterOutletTrackTable.getValueAt(i,0).toString()))
    ...
    private javax.swing.JTextField storageTankCapacityTxtField;
